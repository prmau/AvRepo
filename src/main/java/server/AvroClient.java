...
public class AvroClient {
  ...
  public void newDeviceState(String name) {
    logger.info("Will try to save the new Device State " + name + " ...");
    SaveDeviceStateRequest request = SaveDeviceStateRequest.newBuilder()
    								...
    								.setDs(DeviceState.newBuilder()
    										...
    										.setNamespaceId("0x2")
    										.setTimestamp(Timestamp.newBuilder().setSeconds((60 * 60 * 24) - 1).build())
    										.build()
    										)
    								.build();
